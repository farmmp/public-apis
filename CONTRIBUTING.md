...
|
| API Title(Link to API documentation) | Description of API | Does the API support HTTPS? | Does the API support [CORS](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS)? * | [Does this API have a public Postman Collection?](https://learningpublishing-your-api/run--button/) | 
...
* The Description should not exceed 100 characters. If your description is too long, try summarizing the core functionality briefly.
